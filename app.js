...
const typeVisuals = {
  1: { image: "asset/Reformer.png", jacket: "#f6f0df", accent: "#d7a642", badge: "1" },
  2: { image: "asset/helper.png", jacket: "#ffd8e6", accent: "#e8648d", badge: "LOVE" },
  3: { image: "asset/archiver.png", jacket: "#181a20", accent: "#d7a642", badge: "WIN" },
  4: { image: "asset/individual.png", jacket: "#251a34", accent: "#8f4bd8", badge: "ART" },
  5: { image: "asset/investigator.png", jacket: "#f0eef6", accent: "#6d55a8", badge: "DATA" },
  6: { image: "asset/loyalist.png", jacket: "#1f5fbd", accent: "#6da6ff", badge: "65" },
  7: { image: "asset/enthu.png", jacket: "#078988", accent: "#ffbf3f", badge: "WOW" },
  8: { image: "asset/challenger.png", jacket: "#15161d", accent: "#d84a45", badge: "8" },
  9: { image: "asset/peacemaker.png", jacket: "#4e7a63", accent: "#d7a642", badge: "CALM" },
};
...
function renderTypeAvatar(type, name) {
  ...
  return `
    <div class="type-visual" style="--avatar-jacket: ${visual.jacket}; --avatar-accent: ${visual.accent}" role="img" aria-label="${name} avatar">
      <div class="type-visual-fallback" aria-hidden="true">
        <span>${type}</span>
      ...
      <img
        ...
        alt="${name}"
        loading="lazy"
        onload="this.closest('.type-visual').classList.add('image-loaded')"
        onerror="this.remove()"
      />
    </div>
  `;
